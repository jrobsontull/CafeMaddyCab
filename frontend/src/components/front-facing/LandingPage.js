    ...
    <div className="react-container">
      <div className="content">
        ...
        <div className="info-box" id="child-2">
          <p>
            &#34;It's really terrifying. Every time I see it, I can't help but
            think that, that could've been me&#34; says Madeline Park, the
            founder of Cafe Maddy Cab.
          </p>
          <p>
            If you're an Asian living in this city, we've all felt the same
            way—seeing all the news and headlines about the anti-Asian hate
          ...
          <p>
            From April 2021 what began as a one person's effort to offer taxi
            rides became a widespread crowdfunded program, and with the total
            fundraised amount of more than $250,000, Cafe Maddy Cab paid for
            over <span>7800 essential rides</span> for Asian Women, LGBTQ, and
            Elderly folks of NYC. Cafe Maddy Cab service shut down last year
            after depleting the fund thinking it wouldn't be needed and the city
            felt safer. But with the recent rise in anti-Asian hate crimes in
            2022, we felt the need to relaunch Cafe Maddy Cab.
          </p>
        </div>
